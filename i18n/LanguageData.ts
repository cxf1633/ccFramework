...
export class LanguageData {
    ...
    public static readonly businessBundlePrefix: string = "language-";
    ...
    public static getBusinessBundleName(language: string): string {
        return `${this.businessBundlePrefix}${language.toLowerCase()}`;
    }
